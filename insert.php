      ...
      <div class="container">
          ...
          <form method="post"action="<?php echo $_SERVER['PHP_SELF'];?>">
              <table>
                    <tr>
                        <td colspan="2">
                            Nume:<br><input type="text" name="nume">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            Imagine:<br><input type="text" name="image">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            Culoare:<br><input type="text" name="culoare">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            Marime:<br><input type="text" name="marime">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            Pret:<br><input type="text" name="pret">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
         ...
         <?php
          ...
          if(isset($_POST["submit"])){
              $sql="INSERT INTO flowers (Nume,Culoare,Marime,Pret) VALUES ('{$_POST["nume"]}',
                 '{$_POST["culoare"]}','{$_POST["marime"]}','{$_POST["pret"]}')";
