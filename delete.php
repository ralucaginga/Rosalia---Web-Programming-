...
<html lang="en">
  ...
  <body>
      <?php
            ...
            $sql1="DELETE FROM flowers WHERE ID='{$_GET['id']}'";
            ...
            $sql2="DELETE FROM flowers WHERE ID='{$_GET['id']}'";
  ...
  <div class="site-wrap">
    ...
    <div class="site-section" align="center">
      <div class="container">
        <?php
            include 'connection.php';
            $sql1="SELECT * FROM flowers WHERE ID='{$_GET['id']}'";
            $query=mysqli_query($con,$sql1)or die($mysqli_error($con));
            ...
            $sql2="DELETE FROM flowers WHERE ID='{$_GET['id']}'";
            $query=mysqli_array($con,$sql2)or die($mysqli_error($con));
            header('Location:database.php');
            ?>
